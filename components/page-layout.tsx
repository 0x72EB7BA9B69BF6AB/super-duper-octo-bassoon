...
export function PageLayout({ children, title, subtitle }: PageLayoutProps) {
  ...
  return (
    <div ref={targetRef} className="min-h-screen bg-transparent text-white select-none">
      <Preloader />
      ...
      <div className="relative z-10">
        <motion.section className="flex flex-col items-center justify-center px-4 py-6 sm:py-8">
          <motion.div
        ...
        <motion.section className="py-4 sm:py-6 px-4 sm:px-6 lg:px-8 pb-20">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
