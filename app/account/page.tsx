    ...
    <div className="min-h-screen bg-transparent text-white overflow-hidden select-none">
        ...
        <AlertDialogContent className="bg-black/90 border border-gray-500 text-white">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-gray-400">
              Това ще анулира абонамента ви незабавно. Ще загубите достъп до премиум функциите в края на текущия ви
              период на таксуване.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <Dialog open={showShopifyModal} onOpenChange={setShowShopifyModal}>
        <DialogContent className="bg-black border border-gray-500 text-white">
          <DialogHeader>
            <DialogTitle>Свържете API-тата на вашия Shopify магазин</DialogTitle>
            <DialogDescription className="text-gray-400">
              Въведете данните за вашия Shopify магазин, за да свържете акаунта си.
            </DialogDescription>
          </DialogHeader>
        ...
        <div className="min-h-screen flex flex-col items-center justify-start p-4 pt-12">
          <div className="w-full max-w-2xl mb-12">
            <Card className="bg-transparent backdrop-blur-2xl border-gray-500 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Управлявайте настройките на акаунта си</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                {shopifyDomain ? (
                  <div className="space-y-2">
                    <h3 className="text-lg font-semibold">Свързан Shopify магазин</h3>
                  ...
                  >
                    ...
                    Свържете API-тата на вашия Shopify магазин
                  </Button>
                )}
                <Button
          ...
          <section className="w-full max-w-7xl mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Вашият текущ план</h2>
